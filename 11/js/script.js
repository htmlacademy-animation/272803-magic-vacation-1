...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _timer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timer.js */ "./source/js/modules/timer.js");
/* harmony import */ var _result_animation_manager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./result-animation-manager.js */ "./source/js/modules/result-animation-manager.js");




const GAME_DURATION = 5 * _timer_js__WEBPACK_IMPORTED_MODULE_0__["MILLISECONDS_PER_MINUTE"];
...
class Game {
  ...
  _initResultAnimations() {
    ...
    const resultAnimations = {
      [_result_animation_manager_js__WEBPACK_IMPORTED_MODULE_1__["ResultType"].WIN]: [],
      [_result_animation_manager_js__WEBPACK_IMPORTED_MODULE_1__["ResultType"].LOSS]: null
    };

    const flat = [...this.resultScreens].map((resultScreen) => new _result_animation_manager_js__WEBPACK_IMPORTED_MODULE_1__["default"]({resultScreen}));
  ...
  _onLoose() {
    const lossResultScreen = [...this.resultScreens].find((screen) => screen.dataset.result === _result_animation_manager_js__WEBPACK_IMPORTED_MODULE_1__["ResultType"].LOSS);
    const lossResultAnimation = this.resultAnimations.raw[_result_animation_manager_js__WEBPACK_IMPORTED_MODULE_1__["ResultType"].LOSS];
...
/*!************************************!*\
  !*** ./source/js/modules/timer.js ***!
  \************************************/
/*! exports provided: MILLISECONDS_PER_SECONDS, SECONDS_PER_MINUTE, MILLISECONDS_PER_MINUTE, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MILLISECONDS_PER_SECONDS", function() { return MILLISECONDS_PER_SECONDS; });
...
const MILLISECONDS_PER_MINUTE = SECONDS_PER_MINUTE * MILLISECONDS_PER_SECONDS;
