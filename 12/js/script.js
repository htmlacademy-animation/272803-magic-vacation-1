...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MILLISECONDS_PER_MINUTE", function() { return MILLISECONDS_PER_MINUTE; });
...
/* harmony import */ var _intro_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./intro.js */ "./source/js/modules/intro.js");
/* harmony import */ var _prizes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./prizes.js */ "./source/js/modules/prizes.js");
/* harmony import */ var _game_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./game.js */ "./source/js/modules/game.js");
...
class FullPageScroll {
  constructor() {
    ...
    this.prizesAnimationsManager = new _prizes_js__WEBPACK_IMPORTED_MODULE_2__["PrizesAnimationsManager"]();
    this.game = _game_js__WEBPACK_IMPORTED_MODULE_3__["default"];
  }
  ...
  async changeVisibilityDisplay() {
    for (const screen of this.screenElements) {
      if (screen.classList.contains(`active`) && screen.classList.contains(`screen--story`)
        ...
        _intro_js__WEBPACK_IMPORTED_MODULE_1__["titleTypo"].reset();
        _intro_js__WEBPACK_IMPORTED_MODULE_1__["dateTypo"].reset();
    ...
    window.setTimeout(async () => {
      ...
      if (currentScreen.classList.contains(`screen--intro`)) {
        await _intro_js__WEBPACK_IMPORTED_MODULE_1__["titleTypo"].animate();
        await _intro_js__WEBPACK_IMPORTED_MODULE_1__["dateTypo"].animate();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animator.js */ "./source/js/modules/animator.js");
/* harmony import */ var _timer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./timer.js */ "./source/js/modules/timer.js");
/* harmony import */ var _result_animation_manager_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./result-animation-manager.js */ "./source/js/modules/result-animation-manager.js");




const GAME_DURATION = 5 * _animator_js__WEBPACK_IMPORTED_MODULE_0__["MILLISECONDS_PER_MINUTE"];
...
class Game {
  ...
  _initResultAnimations() {
    ...
    const resultAnimations = {
      [_result_animation_manager_js__WEBPACK_IMPORTED_MODULE_2__["ResultType"].WIN]: [],
      [_result_animation_manager_js__WEBPACK_IMPORTED_MODULE_2__["ResultType"].LOSS]: null
    };

    const flat = [...this.resultScreens].map((resultScreen) => new _result_animation_manager_js__WEBPACK_IMPORTED_MODULE_2__["default"]({resultScreen}));
  ...
  _onLoose() {
    const lossResultScreen = [...this.resultScreens].find((screen) => screen.dataset.result === _result_animation_manager_js__WEBPACK_IMPORTED_MODULE_2__["ResultType"].LOSS);
    const lossResultAnimation = this.resultAnimations.raw[_result_animation_manager_js__WEBPACK_IMPORTED_MODULE_2__["ResultType"].LOSS];
...
/*!************************************!*\
  !*** ./source/js/modules/intro.js ***!
  \************************************/
/*! exports provided: titleTypo, dateTypo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "titleTypo", function() { return titleTypo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dateTypo", function() { return dateTypo; });
/* harmony import */ var _typography_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./typography.js */ "./source/js/modules/typography.js");
...
const [titleTypo, dateTypo] = [title, date].map((element) => {
  return new _typography_js__WEBPACK_IMPORTED_MODULE_0__["default"](element, {
    duration: 200,
    delayIter: 20,
    startDelay: 0,
    property: `transform`
...
/*!*************************************!*\
  !*** ./source/js/modules/prizes.js ***!
  \*************************************/
/*! exports provided: PrizesAnimationsManager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrizesAnimationsManager", function() { return PrizesAnimationsManager; });
/* harmony import */ var _svg_animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./svg-animation.js */ "./source/js/modules/svg-animation.js");
/* harmony import */ var _animator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animator */ "./source/js/modules/animator.js");
...
class PrizesAnimationsManager {
  ...
  _initAnimators() {
    ...
    this.animators = animationsData.map((options, index) => {
      ...
      const animator = new _animator__WEBPACK_IMPORTED_MODULE_1__["default"]({
        fps,
        duration: Infinity,
        onTick: () => {
          if (!data[i]) {
  ...
  _initAnimations() {
    ...
    this.animations = animationsData.map((options, index) => {
      ...
      const animation = new _svg_animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
/***/ "./source/js/modules/result-animation-manager.js":
/*!*******************************************************!*\
  !*** ./source/js/modules/result-animation-manager.js ***!
  \*******************************************************/
/*! exports provided: ResultType, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (ResultAnimationManager);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game */ "./source/js/modules/game.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animator */ "./source/js/modules/animator.js");
...
class Timer {
  ...
  _initAnimator() {
    this.animator = new _animator__WEBPACK_IMPORTED_MODULE_0__["default"]({
      duration: this.duration,
      onTick: (elapsedTime) => {
  ...
  static formatTimestamp(milliseconds) {
    const minutes = Math.floor(milliseconds / _animator__WEBPACK_IMPORTED_MODULE_0__["MILLISECONDS_PER_MINUTE"]);
    const seconds = Math.floor((milliseconds - (minutes * _animator__WEBPACK_IMPORTED_MODULE_0__["MILLISECONDS_PER_MINUTE"])) / _animator__WEBPACK_IMPORTED_MODULE_0__["MILLISECONDS_PER_SECOND"]);
